...
class ClassesReflection {
  ...
  getTargetProperty() {
    return this.#binding.getAttribute('class');
  }

  setTargetProperty(value) {
    this.#binding.setClasses(value);
  }
}
...
class ComputedStylesReflection {
  ...
  get #computedStyler() {
    return this.#context.stylers[COMPUTED_STYLE_TYPE];
  }

  setTargetPropertyProp(prop, value) {
    const prevStyles = this.target[this.property][prop];
    this.#computedStyler.changeStyles(this.#context, prevStyles, value);
  }
}
...
class StylesReflection {
  ...
  setTargetProperty(props) {
    ...
    this.#staticStyler.changeStyles(this.#context, prevStyles, props);
  }
